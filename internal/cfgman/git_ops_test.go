	...
	tests := []struct {
	...
	}{
		{
			...
			setupFunc: func(t *testing.T) (string, func()) {
				tmpDir, _ := os.MkdirTemp("", "cfgman-git-test")
		...
		},
		{
			...
			setupFunc: func(t *testing.T) (string, func()) {
				tmpDir, _ := os.MkdirTemp("", "cfgman-nogit-test")
...
func TestRemoveFromRepositoryTimeout(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "cfgman-timeout-test")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRemoveFromRepositoryGitErrors(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupFunc: func(t *testing.T) (string, func()) {
				tmpDir, _ := os.MkdirTemp("", "cfgman-git-error-test")
		...
		},
		{
			...
			setupFunc: func(t *testing.T) (string, func()) {
				tmpDir, _ := os.MkdirTemp("", "cfgman-readonly-test")
...
func TestRemoveFromRepositoryNoGit(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "cfgman-nogit-test")
	if err != nil {
		t.Fatal(err)
	}
	defer os.RemoveAll(tmpDir)
